...
class TrainingPipeline:
    ...
    def initialize(self):
        ...
        self.data_creator = PoseDatasetCreator(self.config_dict) if self.config_dict["network_name"] == "PoseLSTM" else DataCreator(self.config_dict)
        # self.data_creator = DataCreator(self.config_dict)#PoseDatasetCreator(self.config_dict)
